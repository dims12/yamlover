...
layer and yed disagree, yed is right (see [`docs/server/editor/yed`](../../docs/server/editor/yed/)
for the design discipline, and [`docs/server/editor/projections`](../../docs/server/editor/projections/)
for how the server mounts it).
...
suite (`tools/server`). The state machine chapter `docs/server/yamlover-editor` is the
