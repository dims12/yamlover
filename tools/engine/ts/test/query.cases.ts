...
export const CASES: QueryCase[] = [
  ...
  { q: ': ontos: genre: humor: deadpan: -', fixture: '67-pdf-tags',
    ...
    note: 'members of an onto: the `&…:-` bookmark memberships are its keyless members (docs/annotations/derivation)' },
  ...
  { q: ': jaba00061-0143a.pdf: ?..: !!<format: x-yamlover-onto>', fixture: '67-pdf-tags',
    expect: [':ontos:field:psychology:behavior-analysis', ':ontos:genre:brevity:empty-body',
             ':ontos:genre:humor:deadpan'],
    note: '"ontos of this node" — memberships walked UP, format-filtered (docs/annotations/derivation)' },
  { q: ': jaba00061-0143a.pdf: ?..', fixture: '67-pdf-tags',
    expect: [':', ':ontos:field:psychology:behavior-analysis', ':ontos:genre:brevity:empty-body',
             ':ontos:genre:humor:deadpan'],
    note: 'reverse axis on a filed blob: the containment root plus every onto it is a member of' },
