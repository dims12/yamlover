...
// plus on-demand inverse derivation and `normalize` (→ forwards-only). See docs/language/pointers
 ...
 * every folded `~-` membership is kept (docs/language/pointers/bookmarks). A `!!set` container's dedup is a
