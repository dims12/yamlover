...
| `table` | `x-yamlover-table` | **pending** (`TABLE.md`): rows/header/caption, merged cells (`colSpan`/`rowSpan`) from relative-index `*` pointers; until it lands the node shows in the default view |
